...
import './style.css'
import profile from '../../assets/theoneste.jpg'
        ...
        <div>
            ...
            <section className="contact">
                ...
                <div>
                    ...
                    <p>theoneste99@gmail.com</p>
                </div>
                <div>
                    <span>Phone</span><br></br>
                    <p>+250780850611/+250728812255</p>
                </div>
                <div>
                    <span>Profile</span><br></br>
                    <p>https://theoneste.netlify.app/</p>
                </div>
            </section>
            <section className="footer">
                <div className="name">Developed by <b>Theoneste Nsanzabarinda</b></div>
